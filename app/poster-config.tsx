  ...
  return (
    <View style={styles.page}>
      <View style={styles.topBar}>
       <Text style={styles.topTitle}>{t('poster.title', 'Pósters')}</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.h1}>{t('poster.title', 'Pósters')}</Text>
          <Text style={styles.sub}>{t('poster.subtitle', 'Elige el tamaño del póster')}</Text>
        </View>
